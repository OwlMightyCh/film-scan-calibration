...
def gray_lock_residual(eng):
    ...
    D_P = eng.dnorm_to_reflectance(eng.neutral_input(KK))[1]   # (N,3)
...
def main(argv=None):
    ...
    linf = eng.dnorm_to_linP3(eng.neutral_input(kfine))[0]
    ...
    print("LUT %s: interpolation RMSE %.3e  max %.3e (65^3 tetrahedral vs exact, off-lattice)"
