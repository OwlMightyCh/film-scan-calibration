...
STOCKS = {
    ...
    "pro400h": {
        ...
        # only, on a documented advantage: withheld, those samples refute the
        # canonical +25.00 cyan pin (0.0525 D overshoot, cyan too red) and
        # select the second of two basins 2.4% apart, at a 2% in-band cost.
        # Not admitted elsewhere: Fujifilm 200/400 and Superia Premium 400
