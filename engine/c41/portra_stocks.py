...
STOCKS = {
    ...
    "fujicolor100": {
        ...
        "digitizer": "fuji_digitize.py",
        # 15.0, not the released Kodak 25.0: this is a Fujifilm stock, and the
        # wider bound is documented as reaching a degenerate narrow-dye solution
        # on Fujifilm dye sets.
        "shift_bound_nm": 25.0,
    },
    "superiapremium400": {
