...
basis sensitivity of 0.034-0.063 D (--basis-sensitivity re-derives it) which is
LARGER than the distance between 17 of the 55 pairs, so two stocks agreeing after
...
#
# `--basis-sensitivity` re-derives it over all eleven stocks and the five
...
# canonical basis fits the datasheets several times better than any alternative
# (0.012-0.016 D against 0.029-0.072), so the alternatives are not equally
# credible.
BASIS_UNCERTAINTY_D = (0.034, 0.063)
