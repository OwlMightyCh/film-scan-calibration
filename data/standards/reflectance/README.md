...
ColorChecker. The broad-set fit itself resides in
`engine/retired/c41_scene_engine.py`, which produces no shipped cube and is
retained because it is the only home for that fit, for the ColorChecker
full-chain ΔE2000 harness and for the neutral-axis ramp diagnostic. See
PROJECT.md for the surrounding context.
