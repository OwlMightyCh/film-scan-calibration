...
geometry: the Fujifilm X-T3 and X-T4 carry an X-Trans mosaic, which does not suit this project's scanning workflow. The Fujifilm
GFX 100 is retained, its sensor being Bayer. The list is explicit in
`engine/scan/aces_ssf_import.py`, so cameras
